...
Controls:
Free/Focus Mode is toggled with the F key
Top down / Planar view is toggled with the V key
Camera reset (depending on view mode) is activated with the R key
Skybox is toggled with the P key
